    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Walkcs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Walkcs_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Walkcs_WalkDifficulty_WalkDifficultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Walkcs_RegionId",
                table: "Walkcs",
                column: "RegionId");

            migrationBuilder.CreateIndex(
                name: "IX_Walkcs_WalkDifficultyId",
                table: "Walkcs",
